//TIENES QUE COMENTAR EL DEFINE MOD!!!!
//ESTA CON INDEX 1

//Te ayuda con el problema de saber si un subarreglo es palindrome si 
//es que tienes updates

/*
Maneja dos segment trees, uno extra para inversos
Forma de usar:
prec();
Hashing hash(s);
hash.upd(pos, ch);
hash.is_palindrome(l,r);
*/
