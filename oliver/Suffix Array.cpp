...
/*El LCP Array (Longest Common Prefix Array) se usa junto 
con el suffix array. Para cada sufijo en el suffix array, 
LCP[i] representa la longitud del prefijo común más largo 
entre el sufijo en suffix[i] y el siguiente en suffix[i + 1].*/